...
If you used Tengine, it has a great feature is just set worker_processes and worker_cpu_affinity to auto, nginx will be able to adjust automatically according to the number of cpu.
